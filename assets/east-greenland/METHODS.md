...
All published maps share a fixed RGB stretch (0–0.45 reflectance, gamma 1.2), a turquoise candidate overlay and brown QA-excluded shading. Only rendered 1,600-pixel display previews leave Earth Engine, then Matplotlib adds typography and cartographic elements. Display previews have no scientific raster bands or georeferencing and are not used to calculate statistics.
